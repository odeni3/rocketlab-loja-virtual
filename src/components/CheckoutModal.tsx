      ...
      <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6 relative">
        ...
        {!success ? (
          ...
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <h2 className="text-2xl font-bold text-green-700 mb-2">Compra realizada!</h2>
            <p className="text-gray-600 mb-4">Seu pedido foi salvo no histórico.</p>
            <button className="bg-blue-900 hover:bg-blue-800 text-white font-semibold py-2 px-6 rounded" onClick={onClose}>Fechar</button>
          </div>
        )}
      </div>
    </div>
